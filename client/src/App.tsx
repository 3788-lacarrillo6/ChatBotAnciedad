...
const modules: Module[] = [
  ...
  },
  {
    ...
    icon: 'document',
    description: 'Identificación de emociones'
  },
  {
    id: 'code',
    name: 'Simuladores',
    icon: 'code',
    description: 'Modulo Simuladores sociales básicos'
  },
  {
    id: 'images',
    name: 'Progreso',
    icon: 'image',
    description: 'Resultados de test-Emociones identificadas-Comentario de simulaciones'
  },
/*  {
    id: 'settings',
    name: 'Settings',
    ...
    const icons = {
      ...
      code: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <path d="M9 15c0 1.1 1.45 2 3 2s3-.9 3-2" />
          <path d="M9 9c0 1.1 1.45 2 3 2s3-.9 3-2" />
        </svg>
